...
void main() {
  ...
  test('compresses picked photo into app storage as a relative jpeg path', () async {
  ...
  test('deletes compressed output when it remains above the stored size guard', () async {
    final source = File(p.join(tempDirectory.path, 'source.jpg'));
    await source.writeAsBytes(List<int>.filled(8, 1));
    File? compressedFile;
