...
**Version:** 1.2 (Updated — see changelog at bottom)
...
| Daily reflections, weekly summaries, memories, garden progress, and daily challenge completion | Local database and local app preferences on the device; summaries/challenges are generated by app code on the device only                                                  | No                                                                                      |
...
- Daily reflections, weekly summaries, memory resurfacing, mood garden progress, and daily challenges are local app features. They do not use remote AI, health data, analytics SDKs, accounts, or server processing.
...
| Added retention-loop privacy note (§2/§3)                     | Clarifies that P9 reflection, report, memory, garden, and challenge features remain local-only and do not use remote AI, accounts, health data, or analytics SDKs |
